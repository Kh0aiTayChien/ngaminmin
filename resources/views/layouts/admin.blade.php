...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-green sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('Nga-min.index')}}">
            <div class="sidebar-brand-icon rotate-n-15">

            </div>
            <div class="sidebar-brand-text mx-3">NGA MIN MIN <sup><i class="fas fa-laugh-wink"></i></sup></div>
        </a>
        ...
        @php
            $articles = [
                ['name' => 'Bài viết mới', 'route' => route('articles.create')],
