...
<div class="sec4pc" >
    <div class="content1sec4-HP">
        <div class="row-test">
            ...
            <div class="col-xxl-4 col-md-5 container1sec4-HP">
                ...
                <p class="headersec4 content1sec4">NGŨ CỐC DINH DƯỠNG CHO MẸ BẦU</p>
                <p class="headersec4-semi content1sec4">Dinh dưỡng cho con, Mẹ tròn thiên chức
                </p>
                <p class="contentsec4 content1sec4">Cung cấp đầy đủ dưỡng chất cần thiết cho mẹ bầu và thai nhi như axit
                ...
                <a href="https://minmincare.com.vn/san-pham/ngu-coc-loi-sua">
    ...
    <div class="content2sec4-HP">
        <div class="row-test">
            <div class="col-xxl-4 col-md-5 container2sec4-HP">
                <p class="headersec4 content23sec4">NGŨ CỐC LỢI SỮA CHO MẸ SAU SINH</p>
                <p class="headersec4-semi content23sec4">Khơi dòng sữa, Tròn yêu thương
                </p>
                <p class="contentsec4 content2sec4 textRight">Tăng cường khả năng sản xuất lượng sữa tự nhiên cho mẹ chỉ
                    sau 1
                    tuần sử dụng. Ngoài bổ sung dinh dưỡng, khoáng chất, vitamin mà còn giúp mẹ sau sinh hồi phục sức
                ...
                <a href="https://minmincare.com.vn/san-pham/ngu-coc-me-bau">
                    <svg class="button2 button-shake" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink"
                         width="283.2" height="90.24" viewBox="0 0 283.2 90.24">
                        <g id="Group_881" data-name="Group 881" transform="translate(-1005 -3794.557)">
    ...
    <div class="row-test">
        ...
        <div class="col-xxl-4 col-md-5 container1sec4-HP">
            ...
            <p class="contentsec4 content1sec4">Sản phẩm kết hợp giữa hơn 20 loại hạt ngũ cốc cao cấp: óc chó, hạnh
                nhân, maca… với thành phần sữa non nhập khẩu từ Hoa Kỳ và sữa bột nhập khẩu Newzealand giúp bổ sung hơn
            ...
            <a href="https://minmincare.com.vn/san-pham/sua-hat-dinh-duong">
                <svg class="button2 button-shake" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink"
                     width="283.2" height="90.24" viewBox="0 0 283.2 90.24">
                    <g id="Group_881" data-name="Group 881" transform="translate(-1005 -3794.557)">
...
<div class="sec4mb justify-content-center align-items-center">
    <p class="header1sec4mb">NGŨ CỐC DINH DƯỠNG CHO MẸ BẦU</p>
    <p class="headersec4-semi">Dinh dưỡng cho con, Mẹ tròn thiên chức
    </p>
    <p class="contentsec4mb">Cung cấp đầy đủ dưỡng chất cần thiết cho mẹ bầu và thai nhi như axit folic, chất xơ,
        vitamin D, sắt, canxi,
    ...
    <p class="headersec4-semi">Khơi dòng sữa, Tròn yêu thương
    </p>
    ...
    <p class="header1sec4mb">SỮA HẠT DINH DƯỠNG</p>
    <p class="headersec4-semi">Cả nhà uống ngon, Cùng nhau sống khỏe
    </p>
    <p class="contentsec4mb">
        Sản phẩm kết hợp giữa hơn 20 loại hạt ngũ cốc cao cấp: óc chó, hạnh
        nhân, maca… với thành phần sữa non nhập khẩu từ Hoa Kỳ và sữa bột nhập khẩu Newzealand giúp bổ sung hơn
        30 loại axit amin, vitamin và khoáng chất cần thiết cho sự phát triển toàn diện của cơ thể, tăng cường
        hệ miễn dịch, tốt cho trí não, tim mạch, hệ tiêu hóa, phát triển chiều cao, xương khớp.
    </p>
